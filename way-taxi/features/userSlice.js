...
export const registration = createAsyncThunk("user/registration", async ({ email, password, role, phone, name, surname, driversLicense }, thunkAPI) => {
    try {
        const response = await axios.post("http://localhost:4000/registration", { email, password, role, phone, name, surname, driversLicense },
        axiosConfig)
